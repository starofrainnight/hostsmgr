...
hostsmgr could always use more documentation, whether as part of the
official hostsmgr docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
1. Fork the `hostsmgr` repo on GitHub.
...
3. The pull request should work for Python 3.4 and 3.5. Check
   https://travis-ci.org/starofrainnight/hostsmgr/pull_requests
